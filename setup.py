...
setup(name='lookit',
      ...
      data_files=[('share/applications', ['lookit.desktop']),
          ...
          ('share/icons/ubuntu-mono-light/apps/24', ['icons/ubuntu-mono-light/apps/24/lookit-panel.svg']),
          ('share/icons/ubuntu-mono-light/apps/22', ['icons/ubuntu-mono-light/apps/22/lookit-panel.svg']),
          ('share/icons/ubuntu-mono-dark/apps/24', ['icons/ubuntu-mono-dark/apps/24/lookit-panel.svg']),
          ('share/icons/ubuntu-mono-dark/apps/22', ['icons/ubuntu-mono-dark/apps/22/lookit-panel.svg']),
