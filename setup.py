...
setup(name='lookit',
      ...
      data_files=[('share/applications', ['lookit.desktop']),
          ...
          ('icons/ubuntu-mono-light/apps/24', ['icons/ubuntu-mono-light/apps/24/ubuntu-panel.svg']),
          ('icons/ubuntu-mono-light/apps/22', ['icons/ubuntu-mono-light/apps/22/ubuntu-panel.svg']),
          ('icons/ubuntu-mono-dark/apps/24', ['icons/ubuntu-mono-dark/apps/24/ubuntu-panel.svg']),
          ('icons/ubuntu-mono-dark/apps/22', ['icons/ubuntu-mono-dark/apps/22/ubuntu-panel.svg']),
